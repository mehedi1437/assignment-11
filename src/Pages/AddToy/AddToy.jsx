    ...
    <h1 className="text-5xl font-bold text-center mt-5">Add a Toy!</h1>
      <div className="card-body w-full grid lg:grid-cols-2 gap-4">
        ...
        <div className="form-control">
          ...
          <input type="text" name="photo" placeholder="Toy Pic URL" className="input input-bordered" />
        ...
        <div className="form-control">
          ...
          <input type="number" name="quantity" placeholder="Avaliable quantity" className="input input-bordered" />
        ...
        <div className="form-control">
          ...
          <textarea className="textarea" name="details" placeholder="Details Description"></textarea>
